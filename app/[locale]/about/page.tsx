        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white p-6">
            ...
            <h2 className="text-3xl font-bold mb-3">
              {t("endlessExploration.title")}
            </h2>
            <p className="text-base max-w-xl">
              {t("endlessExploration.description")}
            </p>
          </div>
        </div>
        ...
        <div className="bg-yellow-400 w-full max-w-2xl p-8 flex flex-col items-center text-center shadow-xl rounded-2xl">
          <div className="bg-black p-3 rounded-xl mb-4">
            ...
            >
              ...
              <path
                d="M10 14l-2-2 2-2M14 10l2 2-2 2"
                stroke="black"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <section className="w-full flex flex-col items-center px-4 bg-black">
        ...
        <div className="space-y-4 w-full max-w-3xl">
          {faqs.map((faq, i) => (
            <div
              key={i}
              className="bg-yellow-400 rounded-lg p-0 overflow-hidden"
            >
              <button
      ...
      <section className="w-full flex flex-col items-center justify-center py-4 px-10">
        <div className="w-full max-w-5xl flex flex-col md:flex-row items-center md:items-stretch gap-8 justify-center">
          ...
          <div className="flex flex-col gap-4 md:w-[440px] w-full">
            ...
            <div
              className="grid grid-cols-4 gap-1 md:w-[440px] w-full"
              style={{
                gridTemplateAreas: `
            ...
            >
              ...
              {movies && movies.length > 1 && (
                <div
                  ...
                  className="overflow-hidden h-40 border-4 border-yellow-400 rounded-2xl"
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w500${
                      movies[1].backdrop_path || movies[1].poster_path
                    }`}
                    alt={movies[1].title}
              ...
              {movies && movies.length > 2 && (
                <div
                  style={{ gridArea: "cover1" }}
                  className="overflow-hidden h-28 border-4 border-yellow-400 rounded-2xl"
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w500${
                      movies[2].backdrop_path || movies[2].poster_path
                    }`}
                    alt={movies[2].title}
                    className="object-cover w-full h-full"
                  />
              ...
              {movies && movies.length > 3 && (
                ...
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w500${
                      movies[3].poster_path || movies[3].backdrop_path
                    }`}
                    alt={movies[3].title}
                    className="object-cover w-full h-full"
                  />
              ...
              {movies && movies.length > 4 && (
                <div
                  style={{ gridArea: "cover2" }}
                  className="overflow-hidden h-28 border-4 border-yellow-400 rounded-2xl"
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w500${
                      movies[4].backdrop_path || movies[4].poster_path
                    }`}
                    alt={movies[4].title}
                    className="object-cover w-full h-full"
                  />
              ...
              {movies.slice(5, 9).map((movie, i) => (
                <div
                  key={i + 5}
                  style={{ gridArea: `cover${i + 3}` }}
                  className="overflow-hidden h-24 border-4 border-yellow-400 rounded-2xl"
                >
                  <img
                    src={`https://image.tmdb.org/t/p/w500${
          ...
          <div className="flex flex-col justify-center items-start space-y-6">
            ...
            <button
              className="bg-yellow-400 text-black px-8 py-4 rounded-full font-semibold flex items-center gap-2 hover:bg-yellow-300 transition-colors"
